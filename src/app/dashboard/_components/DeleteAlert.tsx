    ...
    return (
        <div className="fixed inset-0 z-10 overflow-y-auto">
          <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div 
              className="inline-block align-bottom bg-white dark:bg-slate-700  rounded-lg text-left overflow-hidden 
              ...
              <div className="px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div className="sm:flex sm:items-start">
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    <h3 className="text-xl leading-6 font-medium text-gray-900 dark:text-white" id="modal-headline">
                      Alert
                    </h3>
                    <div className="mt-2">
                      <p className="text-sm text-gray-500 dark:text-gray-200">
                        All the time entries related to this task will also be get deleted.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                <Button
                  ...
                  className="w-full inline-flex justify-center rounded-md border border-transparent 
                    ...
                    focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-700 sm:ml-3 
                ...
                <Button
                  ...
                  className="w-full inline-flex justify-center rounded-md border border-transparent 
                    ...
                    focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-700 sm:ml-3 
                    sm:w-auto sm:text-sm my-2 sm:my-0"
